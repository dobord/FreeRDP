...
foreach(expected
        ...
        "session manager rejected login for \$test_user: IPC failure"
...
foreach(expected
        ...
        "FRDP_E2E_GRAPHICAL_LOAD_CONCURRENCY: 2"
...
foreach(expected
        ...
        "for mode in capacity deny malformed restore cli"
        "max_connections = 1"
        "max_connections = 2"
        ...
        "! grep -Eq '^(tls_cert|tls_key|auth_socket|session_socket)"
...
foreach(expected
        ...
        "server-auth.log"
        "failed to reload peer policy from"
        "max_connections=1 active=1"
        "reloaded peer policy.*max_connections=1"
        "2 peer-limit rejections and 2 peer-limit reloads"
        ...
        "RDPGFX capabilities confirmed.*codec=uncompressed"
        "sent first RDPGFX frame codec=uncompressed"
        "graphical-load-result.txt"
        "profile %s is missing graphical load evidence"
...
foreach(expected
        "FRDP_E2E_TIMEOUT"
        "FRDP_AUTH_TIMEOUT"
        "FRDP_E2E_GRAPHICAL_LOAD_CONCURRENCY"
        "FRDP_DENY_LABEL"
        ...
        "export XAUTHORITY"
        "_FRDP_TEST_DESKTOP_TYPE"
        "xfreerdp negotiated the RDPGFX channel"
        ...
        "session-list-after-admission-reload.txt"
        "request_policy_reload cli"
        "run_peer_limit_denied_connection cli-override"
        "session-list-after-cli-admission-reload.txt"
        "explicit CLI admission limit remained authoritative after config reload"
