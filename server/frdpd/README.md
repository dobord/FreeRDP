...
The listener enables NLA/CredSSP, wires the FreeRDP peer `Logon` callback to PAM, and keeps input and
update callbacks as no-op placeholders until desktop/session plumbing is added.
