...
- broker crash during in-flight PAM authentication and manager crashes during in-flight PAM session open/close now have deterministic component coverage; actual service-manager restart execution remains a deployment-level gate;
