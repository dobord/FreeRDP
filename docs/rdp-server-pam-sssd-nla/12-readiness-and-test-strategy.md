...
| Virtual channels | 25% | Static-channel filtering and a DVC authorization hook fail closed; focused WTS deny-path coverage exists | No useful clipboard/audio handlers; `drdynvc` is deliberately guard-denied; no live-client channel tests |
