...
IPC header and auth broker request/response payloads now use explicit
little-endian/fixed-field wire formats, while session, agent, list, and control
payload serialization/versioning plus richer account-policy payloads remain
open.
