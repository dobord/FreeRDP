...
5. Complete helper supervision and deterministic crash recovery. Agent
   ...
   cgroup ownership are implemented; installed/provider login1 evidence remains open.
