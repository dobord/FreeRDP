...
runtime artifact. The local profile requires exactly seven PAM accepts, including
two concurrent graphical load sessions; Samba
...
- scalable multi-session load, long soak, memory growth and crash recovery.
  The local profile proves two concurrent graphical sessions and a separate
