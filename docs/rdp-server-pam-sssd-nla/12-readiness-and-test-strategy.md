...
| Virtual channels | 35% | Static/dynamic filtering, pre-create DVC authorization, conditional `drdynvc` transport, a Display Control handler, disabled-by-default clipboard policy, focused tests, and live-client Display Control evidence exist | No clipboard/audio or other useful handlers and no broader live-client channel matrix |
